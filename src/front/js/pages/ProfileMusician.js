        ...
        <div className="row">
          ...
          <div className="col-lg-9 ">
            <div className="row ">
              ...
              <div className="col-lg-6">
                <iframe
                  ...
                  src={`https://open.spotify.com/embed/track/${perfil?.spotify_url}utm_source=generator`}
                ></iframe>
              </div>
              <div className="col-lg-6">
                <iframe
                  className="w-100 rounded "
                  src={`https://www.youtube.com/embed/${perfil?.youtube_url}`}
                ></iframe>
              </div>
            </div>
            <div className="row mt-3">
              ...
              <p>
                {perfil?.user_instrument.map((element) => (
                  <p>{element.instrument_name}</p>
                ))}{" "}
              </p>
            </div>
            <div className="row mt-3">
              <h3 className="mt-4 mb-3">
                Géneros de música con los que me identifico
              </h3>
              {perfil?.music_genre_user.map((element) => (
                <span
                  className="badge rounded-pill bg-warning m-1 "
                  style={{ width: "min-content" }}
                >
                  {element.music_genre_name}
                </span>
              ))}
            </div>
            <div className="row mt-3">
                ...
                {perfil?.establishments.map((element) => (
                  <CardEstablishment
                    ...
                    establishment_profile_img={
                      element.establishment_profile_img
                    }
                    music_genre_establishment={
                      element.music_genre_establishment
                    }
